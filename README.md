...
[本仓库 Releases](https://github.com/Narcissu-s1/DiscoAS/releases) 中有 Windows 打包文件时，可以下载压缩包，解压后双击 `DiscoAS.exe`。`v1.1.1` 标签包含本页所述源码；没有打包文件时，请按下方“Python 环境下运行”从源码启动。
